...
class Zefoy:
        ...
        while True:
            ...
            if 'Session expired. Please re-login' in self.video_info:
                ...
                while time.time()-2<_+zyfoy:
                    t-=1
                    print("\033[1;32mĐỢI TRONG VÒNG :\033[1;37m {0} ".format(t)+"\033[1;32mGIÂY\033[1;32m", end="\r")
    ...
    def select_service(self):
        while True:
            ...
            output = render('MINHTTOK',colors=['white', 'blue'], align='center')
            print(output)
            print("\033[1;31mTELEGRAM : MINHNGUYEN3004")
            print("\x1b[1;32m—" * 80)
            print(f"""\x1b[1;31m1\x1b[38;5;231m メ NGƯỜI THEO DÕI メ \x1b[1;31mSẮP RA MẮT
\x1b[1;31m2\x1b[38;5;231m メ TRÁI TIM メ \x1b[1;31mSẮP RA MẮT
\x1b[1;31m3\x1b[38;5;231m メ BÌNH LUẬN TRÁI TIM メ \x1b[1;31mSẮP RA MẮT
\x1b[1;31m4\x1b[38;5;231m メ LƯỢT XEM メ \x1b[1;32m2 TUẦN TRƯỚC CẬP NHẬT
\x1b[1;31m5\x1b[38;5;231m メ CHIA SẺ メ \x1b[1;32m2 TUẦN TRƯỚC CẬP NHẬT
\x1b[1;31m6\x1b[38;5;231m メ YÊU THÍCH メ \x1b[1;32m TUẦN TRƯỚC CẬP NHẬT
\x1b[1;31m7\x1b[38;5;231m メ TRỰC TIẾP メ \x1b[1;31mSẮP RA MẮT""")
            print("\x1b[1;32m—" * 80)
            url1=input("\033[1;32mLINK VIDEO TIKTOK : ")
            self.url=url1
            print("—" * 80)
            print(f"\033[1;32mCHỌN DỊCH VỤ ĐI : ", end='')
